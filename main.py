...
class Game:
    ...
    def display(self):
        ...
        screen.blit(aff, (90, 225))

        texte = f"{j2.get_nom()}"
        aff = self.font.render(texte, True, "black")
        screen.blit(aff, (900, 225))


        largeur = 71
        hauteur = 97
        arriere = pygame.image.load("images_cartes/arriere.jpg")
        screen.blit(arriere,(100,100))
        screen.blit(arriere,(1080-(100+71),100))
